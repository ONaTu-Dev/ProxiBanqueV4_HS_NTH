...
public class MainTestCreationClientCompte {
	...
	public static void main(String[] args) {
		...
		IServiceGestionConseiller gerantService = context.getBean("gerantService", ServiceGestionConseiller.class);
		 ...
		 gerantService.addGerant(gerant2,ag2.getId());
		 System.out.println("***************");
		...
		CompteCourant cc = new CompteCourant(2345.55, "123890123", 1000);
		CompteCourant cc1 = new CompteCourant(2345.55, "123890123", 1000);
		CompteCourant cc2 = new CompteCourant(265.55, "234566543", 1000);
		CompteCourant cc3 = new CompteCourant(65.55, "5858575785", 1000);
		CompteCourant cc4 = new CompteCourant(165.55, "757777557", 1000);
	
		CompteEpargne ep = new CompteEpargne(6000.00);
		CompteEpargne ep1= new CompteEpargne(400.00);
		CompteEpargne ep2= new CompteEpargne(400.00);
		CompteEpargne ep3= new CompteEpargne(4500.00);
		CompteEpargne ep4 = new CompteEpargne(6700.00);
		
		serviceGestionClient.addCompteToClient(c.getId(), cc1);
		serviceGestionClient.addCompteToClient(c2.getId(), cc2);
		serviceGestionClient.addCompteToClient(c3.getId(), cc3);
		serviceGestionClient.addCompteToClient(c4.getId(), cc4);
		
		serviceGestionClient.addCompteToClient(c.getId(), ep1);
